...
func kafka_test() {
	...
	defer cancel()
	str := `[{"path":"D:\\N+_project\\cumt_life_jcry\\logs\\error\\error.log","topic":"cumt_life_jcry_log"},{"path":"D:\\N+_project\\cumt_life_feedback\\logs\\django\\error\\error.log","topic":"cumt_life_bxgl_log"}]`
